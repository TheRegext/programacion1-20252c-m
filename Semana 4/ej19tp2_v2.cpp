...
int main(){
    int tipoLenguaje;///variables char: almacenan 1 caracter
    int cantidadHoras;
    int esUrgente;///variables bool: almacenan 1 de dos posibles valores: verdadero (true 1) o falso (false 0)
    ...
    cin>>esUrgente;
    switch(tipoLenguaje){
        case 1:   valorHora=7500;
                    break;
        case 2:   valorHora=6100;
                    break;
        case 3:   valorHora=5400;
                    break;
        case 4:   valorHora=5000;
                    break;
